...
public class SkyBlockMsgFilter {
    ...
    public static String[] filterMessage(String original) {
        ...
        if (original.startsWith("[Bazaar]") && !(original.startsWith("[Bazaar] Putting goods in escrow...") || original.startsWith("[Bazaar] Submitting sell offer...") || original.startsWith("[Bazaar] Claiming orders..."))) return new String[] { "SkyBlock Bazaar", "Bazaar", original.replace("[Bazaar]", "").trim() };
