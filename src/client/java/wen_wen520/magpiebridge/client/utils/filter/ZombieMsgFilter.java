...
public class ZombieMsgFilter {
    ...
    public static String[] filterMessage(String original) {
        ...
        // 1. Gold message: "+15 Gold (Critical Hit)" or "+10 Gold"
